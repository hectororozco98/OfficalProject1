const startAddReimbursementButton = document.getElementById("reimbModalButton");
const addReimbursementModal = document.getElementById('reimbModal');
const backdrop = document.getElementById('backdrop');
const cancelAddReimbursementButton = addReimbursementModal.getElementById('reimbCancel');
...
const sendReimbursementToServer = (newReimbursement) => {
    ...
    console.log('SendReimbursementToServer invoked')
